module.exports = {
	...
	async execute(interaction, client) {
		...
		if(checkUrl(string) === false) return interaction.reply({ content: 'The provided url isnt a valid URI. Example of valid URI: <https://google.com> | Invalid URI: google.com', ephemeral: true });
